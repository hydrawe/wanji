...
export const arabicKeyboardRows: KeyDef[][] = [
  // Arabic alphabet order; variants follow their base letter.
  [
    { latin: 'oc', arabic: 'ء', label: 'oc' }, { latin: 'e', arabic: 'ا', label: 'e' },
    { latin: 'b', arabic: 'ب', label: 'b' }, { latin: 't', arabic: 'ت', label: 't' },
    { latin: 'tv', arabic: 'ث', label: 'tv' }, { latin: 'j', arabic: 'ج', label: 'j' },
    { latin: 'x', arabic: 'ح', label: 'x' }, { latin: 'xv', arabic: 'خ', label: 'xv' },
    { latin: 'd', arabic: 'د', label: 'd' }, { latin: 'dv', arabic: 'ذ', label: 'dv' },
    { latin: 'r', arabic: 'ر', label: 'r' }, { latin: 'z', arabic: 'ز', label: 'z' },
  ],
  [
    { latin: 's', arabic: 'س', label: 's' }, { latin: 'sv', arabic: 'ش', label: 'sv' },
    { latin: 'sc', arabic: 'ص', label: 'sc' }, { latin: 'dc', arabic: 'ض', label: 'dc' },
    { latin: 'tc', arabic: 'ط', label: 'tc' }, { latin: 'zc', arabic: 'ظ', label: 'zc' },
    { latin: 'g', arabic: 'ع', label: 'g' }, { latin: 'gv', arabic: 'غ', label: 'gv' },
    { latin: 'f', arabic: 'ف', label: 'f' }, { latin: 'q', arabic: 'ق', label: 'q' },
    { latin: 'k', arabic: 'ك', label: 'k' }, { latin: 'l', arabic: 'ل', label: 'l' },
  ],
  [
    { latin: 'm', arabic: 'م', label: 'm' }, { latin: 'n', arabic: 'ن', label: 'n' },
    { latin: 'h', arabic: 'ه', label: 'h' }, { latin: 'w', arabic: 'و', label: 'w' },
    { latin: 'y', arabic: 'ي', label: 'y' }, { latin: 'ho', arabic: 'ة', label: 'ho' },
    { latin: 'oe', arabic: 'آ', label: 'oe' }, { latin: 'ec', arabic: 'أ', label: 'ec' },
    { latin: 'ic', arabic: 'إ', label: 'ic' }, { latin: 'o', arabic: 'ٱ', label: 'o' },
    { latin: 'yo', arabic: 'ى', label: 'yo' }, { latin: 'ao', arabic: 'ٰ', label: 'ao' },
    { latin: 'yc', arabic: 'ئ', label: 'yc' }, { latin: 'wc', arabic: 'ؤ', label: 'wc' },
  ],
]
